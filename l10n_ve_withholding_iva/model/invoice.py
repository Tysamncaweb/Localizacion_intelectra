...
class AccountInvoice(models.Model):
    ...
    def action_invoice_open(self):
        ...
        if self.company_id.partner_id.wh_iva_agent and self.partner_id.wh_iva_agent and resul:
            if self.state == 'open':
    ...
    wh_iva = fields.Boolean('Have this invoice been already VAT withheld?',
        compute='_compute_retenida',help="The account moves of the invoice have been retention with"
    ...
    def create_new_wh_iva(self):
        ...
        for inv_brw in self:
            ...
            ret_iva = {
                ...
                'period_id': inv_brw.date_invoice,
    ...
    @api.multi
    def _get_move_lines(self, to_wh, journal_id, writeoff_account_id, writeoff_journal_id,
                          date,name):

...
class HrEmployee(models.Model):
   ...
   # Nro_de_Hijos = fields.Integer('Numero de hijos', size=2)
    ...
    state_id_res = fields.Many2one('res.country.state', 'Estado', domain="[('country_id','=',238)]",required=True)
    city_id_res = fields.Many2one('res.country.city', 'Ciudad',required=True)
